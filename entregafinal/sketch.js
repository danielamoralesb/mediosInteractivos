...
function draw() {
  ...
  if (estado == 10) {
    ...
    textSize(20)
    text("Haz click para pasar al siguiente nivel", 30 * width / 100, 200 * height / 700)
  ...
  if (estado == 21) {
    ...
    image(mioso, 350 * width / 1000, 500 * height / 700, 300 * width / 1000, 350 * height / 700);
    textSize(15);
    text("* Toca los cubiertos para jugar", 820 * width / 1000, 95 * height / 700);
  ...
  if (estado == 18) {
    ...
    stroke(0);
    fill(0);
    text("Ganaste el juego!!!", 250 * width / 1000, 370 * height / 700);
    textSize(20);
    text("Haz click para volver a jugar!", 30 * width / 100, 200 * height / 700);
    image(mioso, 350 * width / 1000, 500 * height / 700, 300 * width / 1000, 350 * height / 700);
  }
