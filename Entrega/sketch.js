...
function draw() {
  ...
  if (estado == 0) {
    ...
    textSize(80);
    text("carrot cake skip", 320 * width / 1000, 350 * height / 700);
  ...
  if (estado == 1) {
    ...
    fill(255);
    textFont("Shadows Into Light");
    text("1. Arrastra a tu personaje por el laberinto", 20 * width / 1000, 60 * height / 700);
    text("2. El oso empieza jugando. Si pierde, es el turno del zorro", 20 * width / 1000, 100 * height / 700);
    text("3. Se juega por niveles y hay un solo ganador en cada uno", 20 * width / 1000, 140 * height / 700);
    text("4. Cuando gana un personaje, hay cambio de nivel para ambos", 20 * width / 1000, 180 * height / 700);
    text("5. El que gane en el primer nivel, comienza jugando en el segundo", 20 * width / 1000, 220 * height / 700);
    text("6. OJO! si tocas la comida voladora por arriba, pierdes", 20 * width / 1000, 260 * height / 700);
    text("7. Si te sales del laberinto, tambien vas a perder", 20 * width / 1000, 300 * height / 700);
    text("8. Recuerda! el oso solo come comida chatarra, pero al zorro solo le gusta la comida saludable", 20 * width / 1000, 340 * height / 700);
    text("9. Suerte! disfruta tu comida", 20 * width / 1000, 380 * height / 700);
    textSize(20);
  ...
  if (estado == 3) {
    ...
    if (dist(mouseX, mouseY, 920 * width / 1000, 120 * height / 700) < 22) {
      estado = 10;
    }
  }
  //primer nivel zorro 
  ...
  if (estado == 4) {
    ...
    image(mioso, x - 60 / 2 * width / 1000, y - 60 / 2 * height / 700, tam * width / 1000, tam * height / 700);
    if (dist(mouseX, mouseY, 765 * width / 1000, 405 * height / 700) < 22) {
      estado = 14;
    }
  }
  ...
  if (estado == 5) {
    ...
    image(mioso, x - 60 / 2 * width / 1000, y - 60 / 2 * height / 700, tam * width / 1000, tam * height / 700);
    if (dist(mouseX, mouseY, 40 * width / 1000, 82 * height / 700) < 22) {
      estado = 18;
    }
  }
